...
class Products extends Model
{
    ...
    public function delete()
    {
        ...
        $sql->query(
            'DELETE FROM tb_cartsproducts WHERE idproduct = :idproduct',
            [":idproduct" => $this->getidproduct()]
        );
    ...
    public static function getPage($page = 1, $itensPerPage = 6)
    {
    ...
    public static function getPageSearch($search, $page = 1, $itensPerPage = 6)
    {
